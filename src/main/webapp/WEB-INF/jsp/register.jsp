                    ...
                    <div class="p-5">
                        ...
                        <form class="user">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <input type="date" class="form-control form-control-user" id="birthday" placeholder="Birthday" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <input type="tel" class="form-control form-control-user" id="phone" placeholder="Phone Number" pattern="[0-9]{3}-[0-9]{4}-[0-9]{4}" required>
                            </div>
